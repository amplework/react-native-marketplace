...
import { getSaleTotalWithReward, hasProduct } from './helpers/utils';
...
import { DiscountType, TIP_DISCOUNT, getSaleTotal, getSaleTotalWithDiscount } from 'containers/createSale/helpers/utils';
...
const SaleCheckout: React.FC<Props> = ({ navigation, route }) => {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      ...
      headerLeft: () => (
        <Text style={styles.titleLeftStyle}>{LABELS.headerTitle}</Text>
      ),
    });
  }, [navigation]);
